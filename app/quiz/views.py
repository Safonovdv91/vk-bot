...
class QuestionAddView(AuthRequiredMixin, View):
    @docs(
        ...
        -------
        у каждого ответа присутствует количество баллов, важно, чтобы сумма всех баллов 
        по итогу была равна 100
        """,
    )
...
class QuestionListView(AuthRequiredMixin, View):
    @docs(
        ...
        description="""
        Отобразить список вопросов, если не указана тема - то отображаются все вопросы
        так же есть quey поля limit и offset - для ограничения выборки
        """,
    )
